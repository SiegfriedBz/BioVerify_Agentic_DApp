			...
			>
				...
				<DialogContent className="min-w-fit sm:max-w-md">
					<DialogHeader>
						...
						<DialogDescription>
							Choose an amount to claim. You will be withdrawn from the
							reviewers pool if your available stake drops below the min
							reviewer stake.
						</DialogDescription>
					</DialogHeader>
					<FieldGroup>
					...
					<DialogFooter>
						...
						<Button form="claim-form-id" className="font-bold" type="submit">
							Claim
						</Button>
					</DialogFooter>
				</DialogContent>
