				...
				<div className="flex items-center justify-between p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
					<div className="flex flex-col gap-1">
						<p className="text-sm font-bold text-amber-500">
							Ineligible for Reviews
						</p>
						<p className="text-xs text-amber-200/70">
							Your available stake is below the requirement. Top up to join the
							active pool.
						</p>
					</div>
					<PayReviewerStakeButton
			...
			{memberData.isAvailable && (
				<div className="flex justify-end">
					<PayReviewerStakeButton
						variant="ghost"
						size="sm"
						className="text-xs font-bold uppercase opacity-50 hover:opacity-100"
					>
						+ Increase Stake
					</PayReviewerStakeButton>
				</div>
