...
import { ChainStats } from "@packages/cqrs"
...
export const ChainStatsContainer = (props: Props) => {
  ...
  const validatedInitialData = activeChainId === server.chainId
    ? server.initialData
    : undefined

  const { data: stats, isFetching, isError, refetch } = useChainStats({
    ...
    <div className="space-y-4 container">
      <div className="grid grid-cols-1 gap-4 @xl:grid-cols-2">
        ...
        <MetricCard
          ...
          description={stats.isLiquidityMissing
        ...
        <MetricCard
          ...
          icon={UsersIcon}
          status={stats.availableReviewersPoolSize < stats.minReviewersPoolSize ? "error" : "default"}
          description={stats.availableReviewersPoolSize < stats.minReviewersPoolSize
