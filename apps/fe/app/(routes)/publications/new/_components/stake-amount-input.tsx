  ...
  return (
    <Controller
      ...
      render={({ field, fieldState }) => (
        <Field data-invalid={fieldState.invalid} className="bg-primary/[0.03] p-6 rounded-2xl border border-primary/10">
          ...
          <FieldDescription className="mt-2 text-[10px] leading-tight text-muted-foreground/80">
            Minimum required stake for this publication is <strong>{minStakeEth} ETH</strong>.
            This amount is locked in the protocol and returned upon successful validation.
          </FieldDescription>
