...
import { Protocol, Publication } from "@packages/schema"
      ...
      <Card className="bg-card/50 border-border">
        <CardHeader className="pb-2">
          <div className="flex items-center gap-2">
            ...
            <TypographyH4 className="text-sm uppercase tracking-wider text-foreground">Economic Weight</TypographyH4>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex justify-between items-end border-b border-border/50 pb-3">
            <TypographySmall className="text-muted-foreground">Total Locked Stake</TypographySmall>
            <div className="text-right">
              <span className="font-mono font-bold text-lg text-primary">{publication.lockedStake}</span>
              <TypographySmall className="ml-1 text-[10px] text-muted-foreground">ETH</TypographySmall>
            </div>
          </div>
          <div className="flex justify-between items-center opacity-70">
            <TypographySmall className="text-[10px] uppercase">Base Publisher Stake</TypographySmall>
            <TypographySmall className="font-mono">{protocol?.publisherStake ?? "..."} ETH</TypographySmall>
          </div>
      ...
      <Card className="bg-card/50 border-border">
        <CardHeader className="pb-2">
          <div className="flex items-center gap-2">
            ...
            <TypographyH4 className="text-sm uppercase tracking-wider text-foreground">Validation Team</TypographyH4>
          </div>
        </CardHeader>
