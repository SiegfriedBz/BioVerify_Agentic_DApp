...
import { TypographyH1, TypographyH2, TypographyH4, TypographyP, TypographySmall } from "@/app/_components/typography"
import { VideoSkeleton } from "@/app/_components/video-skeleton"
import { cn } from "@/lib/utils"
import { BrainCircuitIcon, DnaIcon, ScaleIcon, ShieldCheckIcon } from "lucide-react"
    ...
    <main className="@container grow flex flex-col items-center justify-start pb-24">
      ...
      <section className="w-full max-w-6xl px-4 pt-4 @md:pt-24 flex flex-col items-center text-center gap-6">
        ...
        <TypographyP className="max-w-2xl text-muted-foreground text-lg @md:text-xl">
          A meritocratic peer-review pipeline leveraging LangGraph agents for forensic validation and Chainlink VRF for trustless reviewer selection.
        </TypographyP>
      ...
      <section className="w-full max-w-6xl px-4 mt-24">
        <div className="text-center mb-12">
          <TypographyH2 className="border-none">Protocol Architecture</TypographyH2>
