...
import { GlobalAggregateStats } from "@packages/cqrs"
import { FlaskConicalIcon, GlobeIcon, LandmarkIcon, ShieldAlertIcon, UsersIcon } from "lucide-react"
...
export const StatsContainer = (props: Props) => {
  ...
  const { data: stats, isFetching, isError, refetch
