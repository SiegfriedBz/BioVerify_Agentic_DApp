...
import { PublicationStatusBadge, publicationStatusOptions } from "@/app/_components/publication-status-badge"
import { TypographySmall } from "@/app/_components/typography"
import { Badge } from "@/components/ui/badge"
import { Publication, PublicationStatusSchema } from "@packages/schema"
...
export const columns: ColumnDef<Publication>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      if (reviewers.length === 0 && status === PublicationStatusSchema.enum.SLASHED) {
        return (
