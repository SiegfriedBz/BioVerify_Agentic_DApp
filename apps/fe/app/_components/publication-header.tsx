...
export const PublicationHeader: FC<Props> = (props) => {
  const { publication: { id, pubId, chainId, publisher, status, createdAt }, isSyncing } = props
        ...
        <div className="space-y-1">
          ...
          <div className="flex items-center gap-3">
            <TypographySmall className="text-muted-foreground flex items-center gap-1.5">
              ...
              Indexed on {new Date(createdAt).toLocaleDateString('en-US', {
                dateStyle: 'medium'
              })}
            </TypographySmall>
            <div className="h-3 w-px bg-border" />

            {publisher && <div className="flex items-center gap-2">
