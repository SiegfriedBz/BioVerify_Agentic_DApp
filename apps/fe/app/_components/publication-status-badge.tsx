...
const publicationStatusToColor: Record<PublicationStatus, string> = {
  ...
  [PublicationStatusSchema.enum.PUBLISHED]: "bg-green-500 shadow-[0_0_8px_rgba(34,197,94,0.4)]",
}
...
export const publicationStatusOptions = PublicationStatusSchema.options.map(option => {
  return {
    value: option,
