...
import { IconComponentProps, NetworkBaseSepolia, NetworkSepolia } from '@web3icons/react'
...
export const NetworkToIcon: Record<NetworkT, ForwardRefExoticComponent<Omit<IconComponentProps, "ref"> & RefAttributes<SVGSVGElement>>> = {
