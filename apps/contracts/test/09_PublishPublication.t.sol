...
contract PublishPublicationTest is TestHelpers {
    function test_PublishPublication_DynamicPool_Success() public {
        ...
        _expectEmit_MemberReputation(publisher, reputationBoost);
        ...
        uint256 runningRewardPool = DEPLOY_VALUE - (vrfNumWords * reviewerReward);
    ...
    function test_PublishPublication_RevertIf_NegligentNotReviewer() public {
        ...
        address[] memory negligentButHacked = new address[](vrfNumWords);
