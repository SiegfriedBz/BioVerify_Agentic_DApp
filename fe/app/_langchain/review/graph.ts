...
import { LlmDecisionSchema } from "@/app/_schemas/schemas/langchain/review"
...
/** Persistence Layer: Connects to Supabase/Postgres to enable long-term HITL pauses */
const pool = new Pool({ connectionString: process.env.DATABASE_URL })
const checkpointer = new PostgresSaver(pool)
await checkpointer.setup() //-- only once to initiate Supabase tables
