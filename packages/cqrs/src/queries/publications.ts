...
import { mapPublication, publicationDbSchema, type Publication, type PublicationsResponse } from "@packages/schema"
...
export async function getPublications(
  ...
  try {
    ...
    if (status !== undefined) filters.push(eq(publicationDbSchema.status, status))
